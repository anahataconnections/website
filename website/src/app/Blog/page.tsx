  ...
  return (
    <main className="bg-white text-black" >
      ...
      <Image
          ...
          <div className="my-3 fond-nota text-l">{Blog.data[3].attributes.content[0].children[0].text.substring(0, 150)+"...."}</div>
          ...
          <div className="fond-nota my-3 text-l">{Blog.data[2].attributes.content[0].children[0].text.substring(0, 150)+"...."}</div>
