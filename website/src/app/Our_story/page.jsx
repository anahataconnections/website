  ...
  return (
    ...
    <Navbar />
      ...
      <Image
          ...
          />
        <div className=" flex flex-row justify-between my-10 mx-[68px]  custom3:px-[3rem] customMax:px-20">
            <div >
          ...
          <p className="font-sarabun text-gray-500 text-[35px] font-semibold">Journey Begins on 4th april 2022</p>
            ...
            <div className=" p-2 rounded-xl custom3:-translate-y-[1.8rem] ">
            <Image
        ...
        <p className=" font-sarabun text-[22px] my-2 mx-[62px] custom3:px-[3.15rem] text-black text-justify">Pen auto polygon group edit object polygon. Prototype vector union slice prototype. Blur move subtract flatten editor prototype share device. Component subtract vertical figjam layout auto blur. Team move shadow rectangle component. Italic export connection style background inspect link distribute. Ipsum pixel select layer variant group object. Move rotate vector vertical outline list underline layout ellipse. </p>
          <p className=" font-sarabun text-[22px] my-2 mx-[62px]  text-black text-justify custom3:px-[3.15rem]">Frame layer image figma union variant flows plugin share component. Auto group draft italic auto arrow component prototype. Subtract stroke scale invite reesizing underline share rotate bold project. Draft subtract vertical subtract team text shadow. Select bullet style auto boolean move. Image horizontal line boolean underline library italic polygon figma strikethrough. </p>
          </div>
