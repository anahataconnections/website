...
const Navbar = () => {
  return (
    <header className="bg-[#094C3B] shadow-md h-[70px] flex items-center px-14">
      <div className="flex flex-col md:flex-row justify-between items-center w-full max-w-screen-xl">
        ...
        <div className="flex items-center gap-x-8 font-semibold lg:text-sm md:text-xs sm:text-sm  text-[9px]">
          ...
          <div className="border-solid border-2 border-white bg-[#094C3B] text-white rounded-[32px] w-20 lg:w-24 text-center px-4 py-1 cursor-pointer hover:bg-[#286f5d]"><Link href="/Signin">Sign In</Link></div>
        </div>
