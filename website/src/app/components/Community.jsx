...
const Community = () => {
  return (
    <div className="h-[670px] mt-10 ">
      <header className="font-Pattaya flex items-cente text-centerr justify-center text-[#094C3B] text-[52px]">
        Our Community
      </header>

      <div className="flex items-center justify-center pt-10 pb-10 gap-x-32 overflow-hidden">
