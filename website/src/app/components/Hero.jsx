...
const Hero = () => {
  ...
  return (
    <div className="bg-home-page-back bg-no-repeat bg-custom bg-custom-position">
      ...
      <div className="h-[620px] bg-white-gradient flex flex-col items-center justify-center ">
        <header className="font-Pattaya text-[#0C6242] text-[2.2rem] max-sm:text-[29px] sm:max-md:text-[42px] custom:translate-y-[-50px] custom2:translate-y-[-55px]">
          Why Anahata Connections?
        </header>
        <header className="text-black font-Satisfy text-[27px]  max-sm:text-[20px] sm:max-md:text-[25px] w-[90%] sm:w-[80%] md:w-[70%] custom2:w-[70%] custom3:w-[75%] custom3:text-[1.2rem] text-center ">
        ...
        <div className="flex justify-center">
          <Link
            ...
            className="mt-2 bg-[#094C3B] text-white rounded-[32px] text-[14px] font-sarabun px-5 py-3 cursor-pointer hover:bg-[#286f5d] font-semibold custom:my-8 custom2:my-8"
          >
            KNOW MORE
          </Link>
        </div>
